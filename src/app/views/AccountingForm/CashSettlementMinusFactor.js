...
class CashSettlementMinusFactor extends Component{
    state = {
        amount: "",
        memo: "",
    }
    ...
    render(){
        ...
        for(var idx=0; idx<this.props.data.length; idx++){
            if(parseInt(this.props.data[idx][1]) === this.props.idx){
                if(this.props.data[idx][4] !== "NULL" && this.props.data[idx][4] !== null){
                    memo = this.props.data[idx][4];
                }
                if(this.props.data[idx][3] !== "NULL" && this.props.data[idx][3] !== null){
                    amount = this.props.data[idx][3];
                }
            }
        }
...
export default CashSettlementMinusFactor;