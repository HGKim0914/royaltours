...
const FirstTable = (props) => {
    ...
    var optionProfitGuideTotal = 0;
    var optionProfitTCtotal = 0;
    ...
    for(idx=0; idx<optionProfitIdx; idx++){
        ...
        if(props.optionProfit[idx][7] !== null)
            optionProfitGuideTotal += parseFloat(props.optionProfit[idx][7]);
        if(props.optionProfit[idx][8] !== null)
            optionProfitTCtotal += parseFloat(props.optionProfit[idx][8]);
    }
        ...
        <Table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>${shoppingProfitGuideTotal.toFixed(2)}</td>
                        <td>${shoppingProfitTCTotal.toFixed(2)}</td>
                    </tr>
                    ...
                    <tr>   
                        ...
                        <td>${optionProfitCompanyTotal.toFixed(2)}</td>
                        <td>${optionProfitGuideTotal.toFixed(2)}</td>
                        <td>${optionProfitTCtotal.toFixed(2)}</td>
                    </tr>
...
const DisplayRestaurantExpense = (props) => {
    var eachCost, totalCost = 0;
    var restname, paymentmethod, numpax = "-";
    if(props.data[4] !== null && props.data[5] !== null){
        eachCost = props.data[5] / props.data[4];   // 룸당 가격
    }
    if(props.data[5] !== null){
        totalCost = parseFloat(props.data[5]); // 전체 가격
    }
...
const DisplayHotelExpense = (props) => {
    ...
    return(
        <tr>
            ...
            <td>{(totalprice !== 0)? totalprice.toFixed(2) : totalprice}</td>
        </tr>
    );
}
const DisplayAttExpense = (props) => {
    ...
    return(
        <tr>
            ...
            <td>{(totalprice !== 0)? totalprice.toFixed(2) : 0}</td>
        </tr>
    );
}
const DisplayCarRentalExpense = (props) => {
    return(
        <tr>
            ...
            <td>{(props.data[7] !== null)? parseFloat(props.data[7]).toFixed(2): 0.00}</td>
        </tr>
    );
}
const DisplayMiscExpense = (props) => {
    ...
    return(
        <tr>
            ...
            <td>{(data[5] !== undefined && data[5] !== null)? parseFloat(data[5]).toFixed(2) : 0.00}</td>
...
const DisplayShoppingProfit = (props) => {
    ...
    if(props.data[4] !== null){
        comamount = parseFloat(props.data[4]).toFixed(2);
    }
    if(props.data[3] !== null & props.data[4] !== null){
        com = (parseFloat(props.data[4]) / parseFloat(props.data[3])) * 100 + "%";
    }
    if(props.data[5] !== null){
